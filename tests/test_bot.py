...
# Note: Tests for run_bot() function removed per CONSTITUTION.md §40:
# Those tests only validated mocked interactions without testing real bot behavior.
# Bot initialization and handler registration should be verified through integration tests.

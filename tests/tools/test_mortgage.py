...
def test_loan_calculation_basic():
...
def test_loan_calculation_different_values():
...
def test_loan_calculation_small_loan():
...
def test_loan_calculation_low_interest():
...
def test_loan_calculation_high_interest():
